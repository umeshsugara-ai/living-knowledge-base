...
| U2.1 | in_progress | Promote topics + orgs from the tree deterministically (no LLM) | cheapest real Phase 2 win; also backfills claims.topicRefs, which nothing has ever written |
